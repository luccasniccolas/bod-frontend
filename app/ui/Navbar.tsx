      ...
      <nav className="flex justify-between items-center w-[92%] mx-auto">
        ...
        <div className={`nav-links duration-500 md:static absolute bg-white md:min-h-fit min-h-[60vh] left-0 ${menuOpen ? 'top-[8%]' : 'top-[-100%]'} md:w-auto w-full flex items-center px-5`}>
          <ul className="flex md:flex-row flex-col md:items-center md:gap-[4vw] gap-8">
            <li><Link className="hover:text-white" href='#'>Hombre</Link></li>            
            <li><Link className="hover:text-white" href='#'>Mujer</Link></li>
            <li><Link className="hover:text-white" href='#'>Nosotros</Link></li>
            <li><Link className="hover:text-white" href='#'>Contactanos</Link></li>
          </ul>
        </div>
